...
import { Button, DataTable, Modal, Segmented, Sheet, Tag, useNotify } from "pactra-ui";
import { ARC, ENFORCED_BY, REASON_MEANING, formatUsdc } from "@pactra/fixtures";
...
export default function Refusals() {
  useTitle("Refusals · Pactra console");
            ...
            <dl className="detail__list">
              ...
              <Fact label="Public record">
                <a href={site(`/refusal/${selected.id}`)} target="_blank" rel="noreferrer">
                  pactra.example/refusal/{String(selected.id)} ↗
                </a>
              </Fact>
            </dl>
