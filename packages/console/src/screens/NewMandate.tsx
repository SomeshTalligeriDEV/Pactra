...
import { Button, EmptyState, Field, Select, TextField, useNotify } from "pactra-ui";
import { ARC, MANDATE, formatUsdc, isAddress } from "@pactra/fixtures";
...
export default function NewMandate() {
  useTitle("New mandate · Pactra console");
