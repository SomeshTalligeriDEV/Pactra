...
import { Button, DropdownButton, Logo, Tag, useNoIndex, useNotify } from "pactra-ui";
import { ARC, shortAddress } from "@pactra/fixtures";
    ...
    <div className="shell">
      <header className="bar">
        <div className="bar__inner">
          <Link to="/console" className="bar__brand" aria-label="Pactra console">
            <Logo size={18} />
      ...
      {ready && !mine ? (
        <div className="notice" role="note">
          <div className="notice__inner">
            <span>
              You are viewing the public tree Pactra runs on {ARC.name}. It is read-only.
            </span>
            {available ? (
