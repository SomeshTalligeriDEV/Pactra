 ...
 *
 * Everything else in this repository measures whether Pactra refuses. G1 shows
 ...
 * real task twice over, once under Pactra and once under a plain shared cap,
 ...
 * which is the only structure Pactra has that a single shared cap does not.
 */
