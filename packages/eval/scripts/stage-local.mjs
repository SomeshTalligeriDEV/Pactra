/**
 * A whole Pactra on a local chain, left running.
 *
...
for (const which of ["left", "right"]) {
  ...
  const registered = await asOperator.writeContract({
    ...
    args: [`https://pactra.example/agent/${which}`],
  });
