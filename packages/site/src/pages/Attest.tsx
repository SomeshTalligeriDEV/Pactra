...
import {
  ...
  SETTLEMENT,
  formatUsdc,
} from "@pactra/fixtures";
import { TREE, attestationOf, flatten, type Attestation } from "@pactra/fixtures/preview";
...
export default function Attest() {
  ...
  usePageMeta({
    title: `Attest ${live.state === "live" ? live.data.agentId : node.agentId} · Pactra`,
                    ...
                    <Text variant="body" tone="copy" as="p">
                      ...
                      {body.conduct.attested === body.conduct.refusals ? (
                        ...
                        <>
                          ...
                          <span className="mono">PACTRA_RECORD</span> is enough
                          to cause.
                        </>
                      )}
                    </Text>
