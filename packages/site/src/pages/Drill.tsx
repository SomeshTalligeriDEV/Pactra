...
import { DRILL, EVAL, GATES, MANDATE, SEARCH, SETTLEMENT, formatUsdc } from "@pactra/fixtures";
...
export default function PublicDrill() {
  usePageMeta({
    title: "The hostile drill · Pactra",
    description:
                ...
                columns={[
                  {
                    ...
                    header: "Condition",
                    cell: (condition) => (
                      <b>{condition.id === "pactra" ? "Pactra" : "A plain shared cap"}</b>
                    ),
                  },
                  {
                    id: "completed",
