    ...
    pages: [
      {
        slug: "introduction",
        title: "Introduction",
        summary: "What Pactra is, what it refuses to claim, and who it is for.",
      },
      {
        slug: "quickstart",
        title: "Quickstart",
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        slug: "demo-seller",
        title: "Demo seller",
        summary: "A $1 x402 API on Arc testnet that is not Pactra, to buy from and be refused by.",
      },
      {
        slug: "console",
        title: "Console",
