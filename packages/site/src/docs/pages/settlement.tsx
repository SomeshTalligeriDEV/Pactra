...
import { ARC, ATTEST, GATEWAY, MARKETPLACE, SETTLEMENT, formatUsdc } from "@pactra/fixtures";
 ...
 * Pactra can and cannot be used for: Circle's fee, and the floor it puts under
 * a purchase.
 */
  ...
  return (
    <>
      <Lead>
        ...
        two different clocks, and keeping them apart is what lets Pactra refuse
      ...
      <Table
        ...
        rows={[
          ...
          ["Pactra adds", "the whole check", "nothing at all"],
        ]}
      />
      <P>
        ...
        Pactra bounds is the money that reaches the key doing the signing.
      </P>
      ...
      <P>
        ...
        about Pactra: a payment of a tenth of a cent cannot settle here at all.
      </P>
      <Note tone="warn" title="The other rail is slower, not cheaper">
        ...
        days. Neither rail settles a payment smaller than the fee, so Pactra
      ...
      <P>
        The consequence is precise, and Pactra states it rather than implying
...
export function Console() {
  return (
    <>
      <Lead>
        The console is the half of Pactra a person uses. It holds no key and signs
      ...
      <Table
        ...
        rows={[
          ["What it shows", "the public tree Pactra runs on Arc", "your own tree"],
...
export function Troubleshooting() {
  return (
    <>
      ...
      <Code>{`pactra: no node configured; set PACTRA_NODE_<label> and PACTRA_KEY_<label>`}</Code>
      <P>
      ...
      <P>
        ...
        with <C>PACTRA_MCP_NODE</C>; a node the process holds no key for is
      ...
      <Code>{`record   none. Refusals are enforced and never published; set PACTRA_RECORD`}</Code>
      <P>
        ...
        registry until <C>PACTRA_RECORD</C> names the seat.
      </P>
    </>
  );
}
