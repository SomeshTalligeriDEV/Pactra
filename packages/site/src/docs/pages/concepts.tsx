...
import { MANDATE, REASON_MEANING, formatUsdc } from "@pactra/fixtures";
import { TREE } from "@pactra/fixtures/preview";
  ...
  return (
    <>
      ...
      <P>
        ...
        number is chosen by the agent and neither is chosen by Pactra. A seller
...
export function TheRecord() {
  return (
    <>
      <Lead>
        Pactra writes conduct into ERC-8004, the shared reputation registry that
      ...
      <H2 id="what-pactra-writes">What Pactra writes</H2>
      <P>
...
and here is the refusal it came from`}</Code>
      ...
      <P>
        ...
        write one that reads as Pactra's, and nobody else has refusals to
        report.
      </P>
      ...
      <P>
        ...
        key. Pactra does not register that identity and does not hold it. A
