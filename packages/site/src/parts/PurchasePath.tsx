...
import { Surface } from "pactra-ui";
import { DRILL_RUN, REASON_MEANING, SETTLEMENT, formatUsdc, shortAddress } from "@pactra/fixtures";
import { shortTx, txUrl } from "@pactra/fixtures/preview";
...
const STATIONS: { name: string; sub: string; glyph: ReactNode }[] = [
  ...
  { name: "Pactra", sub: "holds the key", glyph: <FenceGlyph /> },
  ...
  paid: {
    ...
    steps: [
      ...
      },
      {
        from: 1,
        to: 2,
        title: "Pactra asks the contract first.",
      ...
      },
      {
        ...
        body: <>The response comes back through Pactra, and the agent never touched the money.</>,
        code: "200 OK",
      },
    ],
  },
