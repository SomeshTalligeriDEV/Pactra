...
function Step({
  ...
  return (
    <g>
      ...
      {n === undefined ? null : (
        <>
          <circle cx={left + 10} cy={y - 17} r="10" fill="var(--pactra-paper)" stroke="var(--pactra-accent-line)" />
...
function Aside({
  ...
  return (
    <g>
      ...
      {n === undefined ? null : (
        <>
          <circle cx={x + 34} cy={y - 24} r="10" fill="var(--pactra-paper)" stroke="var(--pactra-accent-line)" />
      ...
      >
        <defs>
          <marker id="arch-arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse">
            <path d="M 0 0 L 10 5 L 0 10 z" fill="var(--pactra-copy-dim)" />
          </marker>
        </defs>
        ...
        {LANES.map((lane, index) => (
          <g key={lane.name}>
            <rect
              ...
              fill={index === 1 || index === 2 ? "var(--pactra-paper-raised)" : "transparent"}
              stroke={index === 1 || index === 2 ? "var(--pactra-accent-line)" : "var(--pactra-hairline)"}
            ...
            <path
              ...
              stroke="var(--pactra-hairline-soft)" strokeWidth="1.5" strokeDasharray="2 6"
            />
          </g>
        ))}
