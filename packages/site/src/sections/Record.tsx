import { DotText, Surface } from "pactra-ui";
import { REGISTRY_BASELINE } from "@pactra/fixtures";
  ...
  return (
    <section id="record" className="section">
      <div className="wrap">
        ...
        <Reveal delay={0.08}>
          <Surface glaze="bisque" radius="6" rim elevation="tile" className="panel" style={{ marginTop: "var(--pactra-space-8)" }}>
            ...
            <span className="stat__value" style={{ marginTop: 10 }}>
              <DotText radius={2.05} style={{ width: 150, color: "var(--pactra-ink-strong)" }}>
        ...
        <Reveal delay={0.05}>
          <div className="counter" style={{ marginTop: "var(--pactra-gap)" }}>
            <Surface glaze="bisque" radius="6" rim elevation="tile" className="counter__panel">
              ...
              <p className="panel__note">
                Pactra writes the opposite kind of thing: every entry names the
            ...
            <Surface glaze="bisque" radius="6" rim elevation="tile" className="counter__panel">
              ...
              <span className="stat__value" style={{ marginTop: 10 }}>
                ...
                <DotText radius={2.05} style={{ width: 190, color: "var(--pactra-ink-strong)" }}>
          ...
          <ul className="points points--2" style={{ marginTop: "clamp(48px, 8vh, 96px)" }}>
            <li className="points__item">
              ...
              <p className="points__body">
                The registry is already live on Arc. Pactra writes into what is
