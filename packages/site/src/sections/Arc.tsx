import { BarChart, DotText, Surface, Tag } from "pactra-ui";
import { ARC, ENDPOINTS, MARKETPLACE } from "@pactra/fixtures";
  ...
  return (
    <section id="arc" className="section">
      <div className="wrap">
        ...
        <Reveal delay={0.08}>
          <Surface glaze="ember" radius="6" elevation="tile" glow className="panel" style={{ marginTop: "var(--pactra-space-8)" }}>
            <p className="panel__label" style={{ color: "var(--pactra-on-glaze-soft)" }}>
            ...
            />
            <p className="panel__note" style={{ color: "var(--pactra-on-glaze-soft)" }}>
        ...
        <Reveal delay={0.05}>
          <div className="counter" style={{ marginTop: "var(--pactra-gap)" }}>
            <Surface glaze="bisque" radius="6" rim elevation="tile" className="counter__panel">
              ...
              <span className="stat__value" style={{ marginTop: 10 }}>
                <DotText radius={2.05} style={{ width: 175, color: "var(--pactra-ink-strong)" }}>
            ...
            <Surface glaze="bisque" radius="6" rim elevation="tile" className="counter__panel">
              ...
              <span className="stat__value" style={{ marginTop: 10 }}>
                <DotText radius={2.05} style={{ width: 46, color: "var(--pactra-ink-strong)" }}>
      ...
      <div className="wrap wrap--narrow" style={{ marginTop: "clamp(48px, 8vh, 96px)" }}>
        <Reveal>
          ...
          <p className="lede">
            {ARC.mainnetLaunched
              ? "Arc mainnet is live, and Pactra runs on it."
              : `Arc mainnet has not launched yet. Everything Pactra does today
                 happens on the testnet, and every transaction on this site
                 opens in a public explorer.`}
          </p>
          <div style={{ display: "flex", gap: 8, marginTop: "var(--pactra-space-5)", flexWrap: "wrap" }}>
            <Tag tone="caution" size="sm" dot>
              testnet only
            </Tag>
            <a href={ARC.explorer} target="_blank" rel="noreferrer" className="mono" style={{ color: "var(--pactra-accent)" }}>
              {ARC.explorer}
            </a>
          </div>
        </Reveal>
