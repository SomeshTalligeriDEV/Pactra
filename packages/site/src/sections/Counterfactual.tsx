    ...
    <section id="how" className="section">
      <div className="wrap">
        <Reveal>
          ...
          <p className="lede">
            So run both. Two identical trees on the same task, one pactraed and
            one not.
          </p>
        </Reveal>

        <Reveal delay={0.1}>
          <div className="counter" style={{ marginTop: "var(--pactra-space-8)" }}>
            <Surface glaze="bisque" radius="6" rim elevation="tile" className="counter__panel">
              <div className="counter__head">
                <span className="counter__name">Unpactraed</span>
                <span className="counter__note">nothing adds up the tree</span>
              </div>
              <DelegationTree pactraed={false} height={240} interval={0.7} />
            </Surface>

            <Surface glaze="bisque" radius="6" rim elevation="tile" className="counter__panel">
              <div className="counter__head">
                <span className="counter__name">Pactraed</span>
                <span className="counter__note counter__note--live">the root refuses</span>
              </div>
              <DelegationTree pactraed height={240} interval={0.7} />
            </Surface>
          </div>
        </Reveal>
