...
/* ==========================================================================
   ...
   One grid (24), one stroke (1.6), round joins. Pactra icons are drawn, not
   filled, so they sit on a glaze without punching a hole in it.
   ========================================================================== */

export const PACTRA_ICONS = {
...
export type IconName = keyof typeof PACTRA_ICONS;

export const iconNames = Object.keys(PACTRA_ICONS) as IconName[];
...
export const Icon = forwardRef<SVGSVGElement, IconProps>(function Icon(
  ...
  const d = PACTRA_ICONS[name];
  return (
    <svg
      ref={ref}
      className={cx("pactra-icon", className)}
      viewBox="0 0 24 24"
      width={size ?? "1em"}
      height={size ?? "1em"}
      fill="none"
