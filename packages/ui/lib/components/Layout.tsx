...
export const Container = forwardRef<HTMLElement, ContainerProps>(function Container(
  ...
  return (
    <Tag
      ref={ref}
      className={cx("pactra-container", `pactra-container--${width}`, gutter && "pactra-container--gutter", className)}
      {...rest}
    >
      {children}
    </Tag>
...
export const Grid = forwardRef<HTMLDivElement, GridProps>(function Grid(
  ...
  const vars = {
    "--pactra-grid-columns": columns,
    "--pactra-grid-min": typeof min === "number" ? `${min}px` : min,
  } as CSSProperties;

  return (
    <div
      ref={ref}
      className={cx("pactra-grid", `pactra-grid--gap-${gap}`, `pactra-grid--align-${align}`, min && "pactra-grid--fluid", className)}
      style={{ ...vars, ...style }}
      {...rest}
    >
      {children}
...
export const Stack = forwardRef<HTMLDivElement, StackProps>(function Stack(
  ...
  return (
    <div
      ...
      className={cx(
        "pactra-stack",
        `pactra-stack--${direction}`,
        `pactra-stack--gap-${gap}`,
        `pactra-stack--align-${align}`,
        `pactra-stack--justify-${justify}`,
        wrap && "pactra-stack--wrap",
        className,
      )}
      {...rest}
    >
...
export const Stage = forwardRef<HTMLElement, StageProps>(function Stage(
  ...
  return (
    <section
      ref={ref}
      className={cx("pactra-stage", fullHeight && "pactra-stage--full", className)}
      style={{ ...background, ...style }}
      {...rest}
    >
      {video ? (
        <video
          className="pactra-stage__motion"
          autoPlay
          muted
          loop
          playsInline
