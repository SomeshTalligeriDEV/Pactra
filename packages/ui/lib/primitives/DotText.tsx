...
/**
 * The house display face. Every headline number and hero word in Pactra is set
...
export const DotText = forwardRef<HTMLSpanElement, DotTextProps>(function DotText(
  ...
  const vars = { "--pactra-dot-tone": tone } as CSSProperties;

  return (
    <span
      ref={ref}
      className={cx("pactra-dottext", inline && "pactra-dottext--inline", className)}
      style={{ ...vars, ...style }}
      role="img"
      aria-label={children}
      {...rest}
