...
/**
 * The one surface every other Pactra component is cut from. A card, a modal, a
...
export const Surface = forwardRef<HTMLElement, SurfaceProps>(function Surface(
  ...
  return (
    <Tag
      ...
      className={cx(
        "pactra-surface",
        `pactra-surface--${glaze}`,
        `pactra-surface--r${radius}`,
        `pactra-surface--e${elevation}`,
        showSheen && "pactra-surface--sheen",
        showRim && "pactra-surface--rim",
        interactive && "pactra-surface--interactive",
        glow && "pactra-surface--glow",
        isGlazed && "pactra-on-glaze",
        className,
      )}
