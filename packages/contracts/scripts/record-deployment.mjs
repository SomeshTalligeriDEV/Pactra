  ...
  JSON.stringify(
    {
      ...
      usdc: process.env.PACTRA_USDC ?? null,
      gateway: process.env.PACTRA_GATEWAY ?? null,
      ...
      identity: process.env.PACTRA_IDENTITY ?? null,
      reputation: process.env.PACTRA_REPUTATION ?? null,
      commit: process.env.PACTRA_COMMIT ?? null,
    },
    null,
    2,
  ) + "\n",
