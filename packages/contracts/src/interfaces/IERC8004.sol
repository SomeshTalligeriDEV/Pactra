...
/**
 * ERC-8004 — the registries Pactra writes into, and does not deploy.
 *
 ...
 *
 * Only the functions Pactra actually calls are declared here. An interface is
...
interface IReputationRegistry {
    /**
     * @param value the measurement itself. Pactra writes the amount a bound
