 ...
 *    reads as Pactra's, and they have no refusals to report because they are
 ...
 *    a model's opinion of an agent. If Pactra ever wants to publish a
...
contract ConductRecord {
    ...
    string public constant RECORD_BASE = "https://pactra.example/refusal/";
    ...
    string private constant TAG_REFUSED = "pactra.refused";
     ...
     *
     * Pactra does not register the identity and does not hold it. An agent's
