...
import { pactraFetch, httpTransport, type Transport } from "../../daemon/src/fetch.ts";
...
export function createMcpServer(deps: McpDeps): McpServer {
  const server = new McpServer(
    { name: "pactra", version: "0.1.0" },
    {
      instructions:
        "Pactra bounds what this agent can spend. Use pactra_fetch for any URL " +
  ...
  server.registerTool(
    ...
    {
      description:
        "Fetch a URL. If it answers 402, pay for it through Pactra and return the " +
