/**
 * `demo-seller.pactra.example` — a paid API that is not the record.
 *
 * Every example in this project used to buy from `attest`, which is Pactra
 * selling Pactra's own conduct record. That proves the payment path and reads
