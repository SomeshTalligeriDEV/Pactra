...
> **Provenance note:** This inherited narrative describes the original development process and is not independently verified. Current maintainer: SomeshTalligeriDEV. Codex assisted the September 2026 Pactra rename, architecture review, documentation and validation.
...
**A model is the thing being bounded.** Pactra's whole purpose is to sit in
...
of the bound — `pactra_fetch` takes a URL, and no tool takes a recipient or an
amount.
