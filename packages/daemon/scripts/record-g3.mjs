 ...
 *
 *     PACTRA_DRILL=0x… PACTRA_ROOT=0x… node scripts/record-g3.mjs
 *
...
const drill = process.env.PACTRA_DRILL;
const root = process.env.PACTRA_ROOT;
if (!drill || !root) {
  console.error("PACTRA_DRILL and PACTRA_ROOT must both be set");
  process.exit(2);
}
